...
export const metadata: Metadata = {
  ...
  description: "Browse, share, and discover AI rules for Cursor IDE. A community-driven directory of prompts and configurations.",
};
          ...
          <footer className="border-t py-6 md:py-0">
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
              <p className="text-center text-sm leading-loose text-muted-foreground md:text-left">
                Built for the Cursor community. Open source on GitHub.
              </p>
            </div>
          </footer>
        </div>
